...
import Checkbox from "@/ui/Data input/Checkbox";
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="flex items-center gap-2.5">
        <Checkbox color="primary" className="checkbox-primary" />
        <span className="mt-4 mb-2 flex gap-1 flex-col justify-start">
          <span className="text-xs">
            Al hacer click en la casilla, aseguras haber leído y comprendido los
          </span>
          <Link href="">
            <a className="text-sm text-primary">Terminos y condiciones</a>
          </Link>
        </span>
      </div>
