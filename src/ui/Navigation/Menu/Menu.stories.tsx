...
export const Default: Story<MenuProps> = (args) => {
  return (
    <div className="component-preview flex w-full items-center justify-center p-4 font-sans">
      <Menu {...args}>
        <Menu.Item>
          <a>Item 1</a>
        </Menu.Item>
...
WithCustomColor.args = {
  className:
    'bg-secondary w-56 shadow-xl p-2 rounded-box text-secondary-content',
};
