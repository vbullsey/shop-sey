...
import type { ArtboardProps } from '.';
...
export const Sizes: Story<ArtboardProps> = (args) => {
  return (
    <div className="flex w-auto flex-nowrap space-x-10 overflow-x-auto rounded-2xl bg-neutral p-8">
...
export const Horizontal: Story<ArtboardProps> = (args) => {
  return (
    <div className="flex w-auto flex-nowrap space-x-4 overflow-x-auto rounded-2xl bg-neutral p-8">
